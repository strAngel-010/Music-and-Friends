...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd.show();
        new MyAsyncTask(this).execute(String.valueOf(ID), String.valueOf(myID));

        args = "get_avatar";
        pd.show();
        new MyAsyncTask(this, profileAvatar).execute(String.valueOf(ID), String.valueOf(myID));
